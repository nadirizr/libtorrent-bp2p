...
if build_libtorrent:
    ...
    # Build the BP2P library as well
    _bp2p_sources = glob.glob("./bp2p/src/betterp2p/common/*.cc") + \
                    glob.glob("./bp2p/src/betterp2p/filesystem/*.cc") + \
                    glob.glob("./bp2p/src/betterp2p/algorithm/*.cc") + \
                    glob.glob("./bp2p/src/betterp2p/control/*.cc") + \
                    ["./bp2p/4robin.cc"]
    ...
    libbp2p = Extension(
        ...
        libraries = _libraries,
        library_dirs = _library_dirs,
        sources = _bp2p_sources
    )

    _ext_modules = [libtorrent, libbp2p]
